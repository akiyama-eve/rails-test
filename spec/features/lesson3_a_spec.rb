...
describe 'Lesson3-A introduce to integration test', js: true do
  ...
  it 'sample capybara spec' do
    visit '/lesson2_as'
    save_screenshot("/home/saharak/test1.jpg")
    click_link('New Lesson2 A')
    sleep(1)
    save_screenshot("/home/saharak/test2.jpg")
    fill_in('String test', with: 'John')
    find('#lesson2_a_integer_test').set(5674)
    save_screenshot("/home/saharak/test3.jpg")
    find('[name="commit"]').click
    sleep(1)
    save_screenshot("/home/saharak/test4.jpg")
